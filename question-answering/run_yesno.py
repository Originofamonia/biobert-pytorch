...
from utils_qa import transform_n2b_yesno, eval_bioasq_standard, \
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    logger.info(
        "***** Transform the prediction file into the BioASQ format {} *****".format(
            prefix))
    ...
    eval_score = eval_bioasq_standard(str(5), pred_file, args.golden_file,
                                      args.official_eval_dir)

    print(
        "** BioASQ-yesno Evaluation Results ****************************")
...
def main():
    ...
    parser.add_argument(
        "--golden_file",
        default=f'{data_dir}/7B_golden.json',
        type=str,
    ...
    parser.add_argument(
        "--train_file",
        default=f'{data_dir}/BioASQ-train-yesno-7b.json',
        type=str,
        help="SQuAD json for training. E.g., train-v1.1.json"
    )
    parser.add_argument(
        "--predict_file",
        default=f'{data_dir}/BioASQ-test-yesno-7b.json',
        type=str,
    ...
    parser.add_argument(
        "--per_gpu_eval_batch_size", default=12, type=int,
